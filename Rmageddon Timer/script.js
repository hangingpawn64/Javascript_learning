function main() {
  const dday = new Date("2025-11-09T18:30:00Z"); // i have adjusted the new date to so it matches ist in webpage
  const ddayseconds = Math.floor(dday.getTime() / 1000); // will give dday in seconds
...
if (currentTime < ddayseconds){
  ...
  document.getElementById("nofseconds").innerHTML = timer.seconds;
    ...
    document.getElementById("nofdays").innerHTML = "00";
  document.getElementById("nofhours").innerHTML = "00";
  document.getElementById("nofminutes").innerHTML = "00";
  document.getElementById("nofseconds").innerHTML = "00";
}
}
