...
let timer = {
    ...
    hours : Math.floor(((secondLeft/(60*60*24)) - Math.floor(secondLeft/(60*60*24))) * 24) ,
    minutes : Math.floor( ((((secondLeft/(60*60*24)) - Math.floor(secondLeft/(60*60*24))) * 24) - Math.floor(((secondLeft/(60*60*24)) - Math.floor(secondLeft/(60*60*24))) * 24)) * 60),
    seconds : Math.floor((( ((((secondLeft/(60*60*24)) - Math.floor(secondLeft/(60*60*24))) * 24) - Math.floor(((secondLeft/(60*60*24)) - Math.floor(secondLeft/(60*60*24))) * 24)) * 60) -(Math.floor( ((((secondLeft/(60*60*24)) - Math.floor(secondLeft/(60*60*24))) * 24) - Math.floor(((secondLeft/(60*60*24)) - Math.floor(secondLeft/(60*60*24))) * 24)) * 60)) ) * 60 )
}
